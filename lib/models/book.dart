...
List<Book> listBook = [
  Book(
      name: 'Redhat',
      image: 'assets/images/buku-redhat.png',
      description:
  ...
  Book(
      name: 'Docker',
      image: 'assets/images/buku-docker.png',
      description:
  ...
  Book(
      name: 'Hyper-V',
      image: 'assets/images/buku-hyper-v.png',
      description:
          'Docker adalah sekumpulan platform sebagai produk layanan yang menggunakan virtualisasi tingkat OS untuk mengirimkan perangkat lunak dalam paket yang disebut kontainer.',
      rate: 4.2,
      page: 210,
  ...
  Book(
      name: 'NMS',
      image: 'assets/images/buku-nms.png',
      description:
  ...
  Book(
      name: 'VPN',
      image: 'assets/images/buku-vpn.png',
      description:
  ...
  Book(
      name: 'Openstack',
      image: 'assets/images/buku-openstack-admin.png',
      description:
